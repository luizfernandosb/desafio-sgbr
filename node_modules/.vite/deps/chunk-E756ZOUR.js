...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $2(), it = k(), lt = h(), L, N3, ot = "top";
  ...
  if (a(e)) {
    ...
    if (G(a2, k2)) {
      let n = a2.replaceAll(k2, (l2) => {
        ...
        return `var(${ae2(r, re(c2.join("-")))}${s2(i2) ? `, ${i2}` : ""})`;
      });
...
function Dt(e = {}, t2) {
  if (a(t2)) {
    let r = t2.trim();
    return G(r, k2) ? r.replaceAll(k2, (s4) => F(e, s4.replace(/{|}/g, ""))) : r;
...
var ue = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S2.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = G(t2, k2) ? t2 : `{${t2}}`;
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let { semantic: i2 } = t2 || {};
    return t2 = $3(h2({}, t2), { semantic: $3(h2({}, i2), { primary: s4 }) }), this;
  }, surfacePalette(s4) {
    var o, c2;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l2 = { colorScheme: { light: h2(h2({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h2(h2({}, (c2 = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c2.dark), !!n && { surface: n }) } };
    return t2 = $3(h2({}, t2), { semantic: h2(h2({}, i2), l2) }), this;
    ...
    let a2 = { preset: s4 ? H(S2.getPreset(), t2) : t2, options: i2 ? h2(h2({}, S2.getOptions()), r) : r };
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      ...
      if (i(f2)) o.push({ node: f2, path: p2 });
        ...
        let y2 = ae2(p2), R2 = Y3(f2, p2, s4, [a2]);
        Re(l2, y2, R2);
        let T2 = p2;
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j, O, M2, z3, V2;
  let { preset: a2, options: n } = t2, l2, o, c2, m2, d2, u, g3;
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re2 } = a2, f2 = te || {}, { colorScheme: K3 } = f2, A2 = v2(f2, ["colorScheme"]), x3 = re2 || {}, { colorScheme: X } = x3, G2 = v2(x3, ["colorScheme"]), p2 = K3 || {}, { dark: U2 } = p2, B = v2(p2, ["dark"]), y2 = X || {}, { dark: I } = y2, H2 = v2(y2, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s2(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s2(B) ? this._toVariables({ light: B }, n) : {}, pe = s2(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s2(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s2(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s2(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T2 = q2.declarations) != null ? T2 : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O = pe.declarations) != null ? O : "", pe.tokens || []], [He, We] = [(M2 = fe.declarations) != null ? M2 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g3 = M2 || {}, { dark: te } = g3, re2 = v2(g3, ["dark"]), K3 = s2(O) ? this._toVariables({ [y2]: h2(h2({}, O), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s2(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te) }, r) : {}, [G2, U2] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H2, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I, ...W2])], c2 = m(j, { dt: E2 });
  }
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = G(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g3 = c2 ? `${c2}.${m2}` : m2;
      i(d2) ? n(d2, u, g3) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x3 = {}, p2 = []) => {
        if (i2[u].paths.length === 1) return i2[u].paths[0].computed(i2[u].paths[0].scheme, x3.binding, p2);
        if (f2 && f2 !== "none") for (let y2 = 0; y2 < i2[u].paths.length; y2++) {
          let R2 = i2[u].paths[y2];
          if (R2.scheme === f2) return R2.computed(f2, x3.binding, p2);
        }
        return i2[u].paths.map((y2) => y2.computed(y2.scheme, x3[y2.scheme], p2));
  ...
  if (s2(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c2.reduce((m2, { type: d2, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $3(h2({}, t2), { options: h2(h2({}, this.defaults.options), t2.options) }), this._tokens = b2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = $3(h2({}, this.theme), { preset: e }), this._tokens = b2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N2.emit("preset:change", e), N2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
...
var ge = class {
  ...
  add(t2, r) {
    if (s2(r)) {
      ...
      this._styles.set(t2, $3(h2({}, s4), { element: this.createStyleElement(s4) }));
    }
  }
  update() {
  }
...
//# sourceMappingURL=chunk-E756ZOUR.js.map
