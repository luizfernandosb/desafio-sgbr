...
import {
  ...
  script5 as script12,
  script6 as script14
} from "./chunk-LQFGWGSS.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus
} from "./chunk-7MJ5KG57.js";
import {
  script as script10
} from "./chunk-5R53UUWO.js";
import {
  script as script13
} from "./chunk-HEZCQFWW.js";
import {
  FilterService
} from "./chunk-TFRAIBLH.js";
import {
  script as script2,
  script2 as script4
} from "./chunk-YP7OR3HN.js";
import {
  Ripple
} from "./chunk-C7R7MCWW.js";
import "./chunk-I5XYMTNB.js";
import {
  script as script5,
  script2 as script6
} from "./chunk-ZIVCX6JS.js";
import "./chunk-E7KCLKIT.js";
import {
  script
} from "./chunk-5AQQRAEZ.js";
import {
  BaseStyle
} from "./chunk-VPKYF4AO.js";
import {
  Fragment,
  Transition,
  createBaseVNode,
...
import {
  ...
  x,
  z
} from "./chunk-E455BMJK.js";
import "./chunk-BGOBXLR7.js";
...
var _hoisted_12 = ["aria-label", "data-p"];
var _hoisted_22 = ["src"];
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return $data.visible ? (openBlock(), createElementBlock("div", mergeProps({
    ...
    return [_ctx.image ? (openBlock(), createElementBlock("img", mergeProps({
      ...
      "class": _ctx.cx("image")
    }), null, 16, _hoisted_22)) : _ctx.$slots.icon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.icon), mergeProps({
      key: 1,
      "class": _ctx.cx("icon")
  ...
  }) : createCommentVNode("", true)], 16, _hoisted_12)) : createCommentVNode("", true);
}
...
var script18 = {
  ...
  methods: {
    ...
    getOptionRenderKey: function getOptionRenderKey(option2, index) {
      return this.dataKey ? p(option2, this.dataKey) : this.getOptionLabel(option2) + "_".concat(index);
    },
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      if (selected) value = this.d_value.filter(function(val) {
        return !k(val, _this4.getOptionValue(option2), _this4.equalityKey);
      });
      else value = [].concat(_toConsumableArray3(this.d_value || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
    ...
    getLabelByValue: function getLabelByValue(value) {
      ...
      var matchedOption = options2.find(function(option2) {
        return !_this9.isOptionGroup(option2) && k(_this9.getOptionValue(option2), value, _this9.equalityKey);
      });
    ...
    scrollInView: function scrollInView() {
      ...
      this.$nextTick(function() {
        ...
        var element = z(_this21.list, 'li[id="'.concat(id, '"]'));
        if (element) {
  ...
  computed: {
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread(_objectSpread({}, group), {}, _defineProperty$1({}, typeof _this23.optionGroupChildren === "string" ? _this23.optionGroupChildren : "items", _toConsumableArray3(filteredItems))));
          });
    ...
    allSelected: function allSelected() {
      var _this24 = this;
      return this.selectAll !== null ? this.selectAll : s(this.visibleOptions) && this.visibleOptions.every(function(option2) {
    ...
    dropdownIconDataP: function dropdownIconDataP() {
      return f(_defineProperty$1({}, this.size, this.size));
    },
...
var _hoisted_23 = ["id", "disabled", "placeholder", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-invalid"];
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("hiddenInput")), null, 16, _hoisted_23)], 16), createBaseVNode("div", mergeProps({
  ...
  })], 16, _hoisted_32)], 16), $options.isClearIconVisible ? renderSlot(_ctx.$slots, "clearicon", {
    key: 0,
          ...
          return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            icon: withCtx(function(slotProps) {
              return [_ctx.$slots.headercheckboxicon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.headercheckboxicon), {
                ...
                key: 1,
                "class": [slotProps["class"], _defineProperty2({}, _ctx.checkboxIcon, slotProps.checked)]
