...
var shouldSkipSourceCodeGeneration = (context) => {
  ...
  return (sourceParams == null ? void 0 : sourceParams.type) === gt.DYNAMIC ? false : !(context == null ? void 0 : context.parameters.__isArgsStory) || (sourceParams == null ? void 0 : sourceParams.code) || (sourceParams == null ? void 0 : sourceParams.type) === gt.CODE;
};
var parseDocgenInfo = (component) => {
  if (!component || !("__docgenInfo" in component) || !component.__docgenInfo || typeof component.__docgenInfo != "object") return { displayName: component == null ? void 0 : component.__name, eventNames: [], slotNames: [] };
